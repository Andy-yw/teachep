...
class File extends Base
{
     ...
     */
    public function getHomeFileList($id,$num,$startpage){
       /* $ChapterList=Chapter::where("course_id",$id)->pluck('id')->toArray();
        $ImageTextList= ImageText::whereIn("chapter_id",$ChapterList)
                        ->with(['ImageText','User'])
                        ->get();*/
        $FileList= File::select("id","file_name","file_address","created_at")
                      ->where("course_id",$id)
