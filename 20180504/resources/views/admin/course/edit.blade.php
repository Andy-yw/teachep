                    ...
                    <form role="form">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input type="type" class="form-control" name="course_name" id="course_name" value="{{$data->course_name}}" >
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control"  name="course_type_id" id="course_type_id">
                                    ...
                                    @foreach($coursetypelist as $k => $v)
                                        <option value="{{ $v->id }}" @if($data->course_type_id==$v->id) selected="selected" @endif>
                                            {{ $v->couser_type_name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="course_difficult" id="course_difficult" style="width: 100%;">
                                    <option value="3"  @if($data->course_difficult==3) selected="selected" @endif >困难</option>
                                    <option value="2" @if($data->course_difficult==2) selected="selected" @endif>中等</option>
                                    <option value="1" @if($data->course_difficult==1) selected="selected" @endif>简单</option>
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="module_id" id="module_id"  style="width: 100%;">
                                    @foreach($modulelist as $k => $v)
                                        <option value="{{$v->id}}" @if($data->module_id==$v->id) selected="selected" @endif >{{$v->module_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="exampleInput">课程封面</label>
                                <img width="220"  height="220" id="upimg" src="{{ asset($data['course_img']) }}" alt="Avatar">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="course_status" id="course_status" style="width: 100%;">
                                    <option value="1"  @if($data->course_status==1) selected="selected" @endif>显示</option>
                                    <option value="0"  @if($data->course_status==0) selected="selected" @endif>不显示</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="exampleInput">课程简介</label>
                                <textarea class="form-control"  name="course_introduction" id="course_introduction">{{$data->course_introduction}}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="exampleInput">课程详细介绍</label>
                                <div id="editor">{{$data->course_text}}</div>
                            </div>
                        </div>
...
@section('js')
    ...
    <script>
        ...
        $("#addit").click(function() {
            ...
            $.post("{{ url('admin/course/update', [$data->id]) }}",{
