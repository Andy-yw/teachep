            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li>
                            <a href="{{ url('admin/module/index') }}"><i class="fa fa-toggle-on"></i>模块列表</a>
                        </li>
                        <li>
                            <a href="{{ url('admin/picture/index') }}"><i class="fa fa-bell "></i>轮播列表</a>
                        </li>
                    </ul>
                </li>
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li>
                            <a href="{{ url('admin/attribute/index') }}"><i class="fa fa-toggle-on"></i>课程属性列表</a>
                        </li>
                        <li>
                            <a href="{{ url('admin/coursetype/index') }}"><i class="fa fa-bell "></i>课程类别列表</a>
                        </li>
                        <li>
                            <a href="{{ url('admin/course/index') }}"><i class="fa fa-bell "></i>课程列表</a>
                        </li>
                    </ul>
                </li>
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li>
                            <a href="{{ url('admin/article/index') }}"><i class="fa fa-circle-o"></i>文章列表</a>
                        </li>
                        <li>
                            <a href="{{ url('admin/articletag/index') }}"><i class="fa fa-circle-o"></i>文章标签列表</a>
                        </li>
                        <li>
                            <a href="{{ url('admin/articletype/index') }}"><i class="fa fa-circle-o"></i>文章分类列表</a>
                        </li>
                    </ul>
                </li>
                <li class="treeview">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li>
                            <a href="{{ url('admin/user/index') }}"><i class="fa fa-toggle-on"></i>用户列表</a>
                        </li>
                        <li>
                            <a href="{{ url('admin/user/index') }}"><i class="fa fa-toggle-on"></i>用户认证信息表</a>
                        </li>
                        <li>
                            <a href="{{ url('admin/school/index') }}"><i class="fa fa-bell "></i>学校列表</a>
                        </li>
                    </ul>
                </li>
                <li class="treeview">
  			...
  			<i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li>
                            <a href="{{ url('admin/virtual/index') }}"><i class="fa fa-circle-o"></i> 虚拟机列表</a>
                        </li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li>
                            <a href="{{ url('admin/Comment/index') }}"><i class="fa fa-circle-o"></i>评论列表</a>
                        </li>
                    </ul>
                </li>
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li>
                            <a href="{{ url('admin/admin/index') }}"><i class="fa fa-circle-o"></i>管理员列表</a>
                            <a href="{{ url('admin/authgroup/index') }}"><i class="fa fa-circle-o"></i>角色列表</a>
                            <a href="{{ url('admin/authrule/index') }}"><i class="fa fa-circle-o"></i>权限列表</a>
                        </li>
                    </ul>
                </li>
                <li class="treeview">
