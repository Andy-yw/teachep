                        ...
                        <form role="form">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="introduction" style="resize: vertical;" name="article_introduction"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInput">文章内容</label>
                                    <textarea id="course_text" style="resize: vertical;" name="article_text"></textarea>
                                </div>
                            </div>
