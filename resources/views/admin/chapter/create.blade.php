                        ...
                        <form role="form">
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="exampleInput">章节名称</label>
                                    <input type="type" class="form-control" name="chapter_name" id="chapter_name" placeholder="请输入章节名称">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInput">章节介绍</label>
                                    <textarea id="introduction" style="resize: vertical;" name="chapter_introduction"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInput">章节详细介绍</label>
                                    <textarea id="course_text" style="resize: vertical;" name="chapter_text"></textarea>
                                </div>
                            </div>
