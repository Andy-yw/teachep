...
@section('title', '课程章节列表')

@section('nav', '课程章节列表')

@section('description', '课程章节图')
...
@section('content')
    ...
    <section class="content-header">
        <h1>
            <small>课程章节列表</small>
            &nbsp;&nbsp;
            <a  href="{{ url('admin/chapter/create') }}" class="btn btn-info" ><i class="glyphicon glyphicon-plus"></i>新增课程章节</a>
                        ...
                        <form action="{{ url('admin/module/sort') }}" method="post">
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>2018-03-25</td>
                                    <td>
                                        <a href="{{ url('admin/imagetext/index') }}">章节图文</a>
                                        |
