...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="kvmlist.html">虚拟机列表</a></li>
                        ...
                        <form role="form">
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="exampleInput">虚拟机名</label>
                                    <input type="type" class="form-control" name="kvm_name" id="kvm_name" placeholder="请输入虚拟机名">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInput">虚拟机类型</label>
                                    <select class="form-control select2" name="course_type" style="width: 100%;">
                                        <option selected="selected">类型1</option>
                                        <option>类型2</option>
                                        <option>类型3</option>
                                        <option>类型4</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputFile">IP地址</label>
                                    <input type="type" class="form-control" name="kvm_ip" id="kvm_name" placeholder="请输入IP地址">
                                    <!--<p class="help-block">Example block-level help text here.</p>-->
                                </div>
                                <div class="form-group">
                                    <label for="exampleInput">介绍说明</label>
                                    <textarea id="introduction" style="resize: vertical;" name="kvm_introduction"></textarea>
                                </div>
