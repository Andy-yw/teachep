<?php $__env->startSection('title', '课程列表'); ?>

<?php $__env->startSection('nav', '课程列表'); ?>

<?php $__env->startSection('description', '课程图'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content-header">
        <h1>
            <small>课程列表</small>
            <a  href="<?php echo e(url('admin/course/create')); ?>" class="btn btn-info" ><i class="glyphicon glyphicon-plus"></i>新增课程</a>
...
<?php $__env->startSection('js'); ?>
    <script src="<?php echo e(asset('js/admin/jquery/dist/jquery.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('js/admin/layer/layer.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('js/admin/layer/laydate/laydate.js')); ?>"></script>
    <script>
        $(function() {
